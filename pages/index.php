...
<body class="theme-blush">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon traffic">
                        <div class="body">
                            ...
                            <div class="progress">
                                <div id="progress_res id" class="progress-bar l-amber" role="progressbar"
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon sales">
                        <div class="body">
                            ...
                            <div class="progress">
                                <div id="progress_ca" class="progress-bar l-blue" role="progressbar" aria-valuenow="38"
    ...
    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Reservation Info </h4>
                </div>

                <div class="modal-body">
                    <table id="tableres" class="display" style="width:100%">
                        <thead>
                            <tr>
                                <th>Client</th>
                                <th>Type</th>
