...
<body class="theme-blush">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="card">
                    <div class="body">
                        <h3 align="center">Réservez Dès Maintenant !</h3>
                        <div id="calendar">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Demander Une Reservation</h4>
                </div>
                <div class="modal-body">

                </div>
                <div class="modal-footer">
                    <button class="btn save-btn btn-success" id="send">Save</button>
    ...
    <script src="../assets/js/pages/calendar/calendar_agence.js"></script>
