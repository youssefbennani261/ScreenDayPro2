...
// $req =mysqli_query($con,"select Email from agence where Num_agence=".$_SESSION['agence'][0]."") or die ("progleme rquite");
        
// ini_set('display_errors',1);
// error_reporting(E_ALL);
//            $message=" Il y a une demande de changement de mot de passe. Entrez un lien Localhost:8080/ScreenDayPro2/pages/edit_profile_agences";
//            $message=wordwrap($message,30);
//            $Mmail=$req;
//            $sub="ScreenDay.com";
//         $rsu=mail($Mmail,$sub,$message, "From:0642556687youssef@gmail.com");
//        printf($rsu);
//         echo var_dump($rsu);
